...
import 'package:referral_app/authentication/login2.dart';
    ...
    return Container(
      ...
      child: ListView(
        children: <Widget>[
          ...
          CircleAvatar(child: PNetworkImage(LoginTwoPage.origami), maxRadius: 50, backgroundColor: Colors.transparent,),
